          ...
          <table className="w-full text-sm">
            <thead className="bg-stone-50 border-b border-stone-200">
              <tr>
                ...
                <th className="text-right px-4 py-3 font-medium text-stone-600">العميل</th>
                <th className="text-right px-4 py-3 font-medium text-stone-600">عنوان الشحن</th>
                <th className="text-right px-4 py-3 font-medium text-stone-600">الإجمالي</th>
                <th className="text-right px-4 py-3 font-medium text-stone-600">المنتجات</th>
                <th className="text-right px-4 py-3 font-medium text-stone-600">التاريخ</th>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2">
                        ...
                        <select
                          ...
                          className="text-xs border border-stone-200 rounded-lg px-2 py-1 focus:outline-none focus:ring-2 focus:ring-emerald-400 disabled:opacity-50 bg-white"
                        >
                          {STATUSES.map((s) => (
